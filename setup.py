...
setup(
    ...
    classifiers=[  # Optional
        ...
        'Intended Audience :: Feedstock manufacturers and end-users',
        'Topic :: 3D Printing :: Material Testing',
    ...
    install_requires=['docopt', 'mecode', 'numpy', 'scipy', 'shapely', 'trimesh', 'descartes', 'jsonpickle', 'matplotlib', 'pillow', 'reportlab', 'patoolib', 'flask'],  # Optional
