...
current_test = {"test_name": ts.test_name, "tested_values": ts.values, "tested_speed_values": np.linspace(min_max_speed_printing[0],min_max_speed_printing[1],4).tolist(), "selected_value": 0, "selected_speed_printing_value": 0, "units": ts.units}
