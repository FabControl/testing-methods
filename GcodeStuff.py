...
class Gplus(G):
    ...
    def set_extruder_temperature(self,
        ...
        G.write(self, t.substitute(temp=temperature, tool=extruder.tool))
        if return_string:
    ...
    def set_chamber_temperature(self,
        ...
        if "T" in chamber.tool:
            t = Template(gcode_command)
            G.write(self, t.substitute(temp=temperature, tool=chamber.tool))
            if return_string:
    ...
    def set_part_cooling(self,
        ...
        G.write(self, t.substitute(cool=int(255 * (cooling_power / 100))))
        if return_string:
    ...
    def set_ventilator_exit(self,
        ...
        G.write(self, t.substitute(tool=chamber.ventilator_exit_tool,cool=int(255 * (cooling_power / 100))))
    ...
    def teardown(self, wait=True):
        """ Close the outfile file if opened. This method must be called once after all commands.
        """
