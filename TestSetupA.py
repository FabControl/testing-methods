...
class TestSetupA(object):
    def __init__(self, machine: Machine, material: Material, test_info: TestInfo, path: str, min_max_argument: list=None, min_max_speed_printing: list=None):
        ...
        self.track_height = [x * machine.nozzle.size_id for x in self.coef_h]
        self.track_width = [x * machine.nozzle.size_id for x in self.coef_w]
        ...
        argument_list = [self.temperature_extruder, self.track_height, self.track_width, self.extrusion_multiplier, self.speed_printing, self.retraction_distance, self.retraction_restart_distance, self.extrusion_multiplier_bridging]
